...
const exploreLinks = [
  {
    icon: HelpCircle,
    title: 'How Pay-Never works',
    description: 'See how collateral yield repays your purchases while you keep the principal',
    href: '#methodology',
    external: false,
  },
  {
    ...
    <footer className="relative w-full bg-transparent border-t border-white/5 mt-12">
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-16">
        <h2 className="text-4xl md:text-5xl font-light text-foreground mb-12 text-[#ebebeb]">
          Explore <span className="font-semibold text-lime-accent">private consumer finance</span>
        </h2>
